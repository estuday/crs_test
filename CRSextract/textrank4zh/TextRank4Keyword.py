...
class TextRank4Keyword(object):
    ...
    def analyze(
        ...
        util.debug(
            "self.words_no_stop_words in TextRank4Keyword:\n", self.words_no_stop_words
        )
        util.debug(
            "self.words_all_filters in TextRank4Keyword:\n", self.words_all_filters
        )
    ...
    def get_keyphrases(self, keywords_num=12, min_occur_num=2):
        ...
        return [
            phrase for phrase in keyphrases if self.text.count(phrase) >= min_occur_num
        ]
